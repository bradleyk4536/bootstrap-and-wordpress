...
<section id="course-features">
	<div class="container">
		<div class="section-header">
			<img src="assets/images/icon-rocket.png" alt="Rocket">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				<iframe width="100%" height="415" src="//www.youtube.com/embed/69nEzHLy_tM" frameborder="0" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-md-6">
				<div class="row">
					<div class="col-lg-8">
						<h2>Your Instructor <small>Ken Bradley</small></h2>
					</div>
					<div class="col-lg-4">
