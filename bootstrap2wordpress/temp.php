...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			[email* class:form-control class:input-lg id:contact-email placeholder "Your email"]
		</div>
	</div>
	<div class="col-sm-12">
		<div class="form-group">
			<label for="contact-subject" class="sr-only">Subject</label>
			[text* your-name class:form-control class:input-lg id:contact-subject placeholder "Subject"]
		</div>
	</div>
	<div class="col-sm-12">
		<div class="form-group">
